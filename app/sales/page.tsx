...
function cashierCopy(activity: string) {
  ...
  if (experience === "PART_LOOKUP") return { title: "اكتب رقم القطعة واعرف المتوفر", note: "ابحث برقم القطعة، اخترها وحدد الكمية. التقارير والتكلفة تبقى عند المالك." };
...
export default async function SalesPage() {
  ...
  const description = experience === "MENU"
    ...
    : experience === "PART_LOOKUP"
      ? "ابحث برقم القطعة أو اسمها، اعرف المتوفر وأضفها للسلة مباشرة."
      : experience === "BARCODE"
